...
h2_black_list = ['contents', 'links to related sites', 'related links', 'links to related allTalesData',
...
for page in type1_with_content:
    ...
    for a in type1_page_links[1:]:
        ...
        if start != None and exclude_black_list(start.get_text(), h2_black_list):
            ...
            save_txt(text, 'allTalesData/' + title) if num_words[-1] >= 15 else num_words.pop()
        else:
            page_skip += 1
